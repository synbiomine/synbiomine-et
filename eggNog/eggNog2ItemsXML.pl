...
my $usage = "eggNog2ItemsXML.pl <domain_set> <taxon_ID_file> <im_model_file.xml>
...
Required files:
taxon_ID_file - format: taxID1 taxID2 ... taxID
taxon_ID_file is generated by the download scripts, fetchSynbioData.pl and fetchArchaeaData.pl
